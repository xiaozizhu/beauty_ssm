...
<body>
	<div class="container">
		<div class="panel panel-default">
			...
			<table>
				<div style="float: left"><a href="/goods/add"><input class="btn btn-info" type="button" name="添加商品" value="添加商品"/></a></div>
				<div style="float: right"><button id="logout">退出登录</button></div>
