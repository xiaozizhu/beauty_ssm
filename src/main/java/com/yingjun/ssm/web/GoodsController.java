...
public class GoodsController {
    ...
    @ResponseBody
    public BaseResult<Object> addpost(@CookieValue(value = "userPhone", required = false) Long userPhone,
                                      @Valid Goods goods, BindingResult result) {
        LOG.info(goods+"invoke----------/goods/adds---post");
        if (userPhone == null) {
            return new BaseResult<Object>(false, ResultEnum.INVALID_USER.getMsg());
        }
        ...
        try {
            LOG.info("invoke----------/goods/adds---post---success");
            goodsService.addGoods(userPhone,title,price,number,state);
